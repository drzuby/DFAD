...
public class CallsBroadcastReceiver extends BroadcastReceiver {
    ...
    protected void onIncomingCallStarted(Context ctx, String number, Date start) {
        callsListener.onIncomingCallStarted();
    }

    protected void onOutgoingCallStarted(Context ctx, String number, Date start) {
        callsListener.onOutgoingCallStarted();
    }

    protected void onIncomingCallEnded(Context ctx, String number, Date start, Date end) {
        callsListener.onIncomingCallEnded();
    }

    protected void onOutgoingCallEnded(Context ctx, String number, Date start, Date end) {
        callsListener.onOutgoingCallEnded();
    }

    protected void onMissedCall(Context ctx, String number, Date start) {
        callsListener.onMissedCall();
    }
